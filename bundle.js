...
`,ae=k.create`
    <div class="${({options:e})=>se(e).content}">
        ${({options:e})=>e.renderChildren&&e.renderChildren()}
    </div>
`,ie=k.create`
    <div class="${({options:e})=>se(e).footer}">
        ${({options:e})=>e.renderChildren&&e.renderChildren()}
    </div>
`,se=e=>e.classes?{...re.classes,...e.classes}:re.classes,oe=({variant:e,color:t,shadow:r})=>({variant:e,color:t,shadow:r}),le=k.create`
    <div
        class="${({options:e})=>(e=>{const t=se(e);return[e.className||null,t.root,e.top?t.top:null,e.bottom?t.bottom:null,e.left?t.left:null,e.right?t.right:null].join(" ")})(e)}"
        onClick=${{"&":function(e){this.options.handleClose&&e.target===this.el&&this.options.handleClose()}}}
    >
        <${te} ${({options:e})=>({...oe(e),className:se(e).modal,tag:"div"})}>
            ${e=>e.renderContent()}
        </${te}>
    </div>
`.extend({renderContent(){return this.options.renderChildren?this.options.renderChildren():this.partial`
            ${this.options.handleClose?this.partial`<${ne} ${{...this.options}} />`:null}
            ...
            ${this.options.renderButtons?this.partial`
                    ...
                    `:null}
        `}});le.Header=ne,le.Content=ae,le.Footer=ie;const{classes:ce}=F({root:{display:"flex",justifyContent:"right",alignItems:"center",height:"60px","& ul":{padding:0}},icon:{width:"24px",height:"24px",cursor:"pointer",fill:"var(--rui-palette-neutral-main)","&:hover":{fill:"var(--rui-palette-neutral-dark)"}},hiddenIfLight:{display:"var(--rui-app-hiddenIfLight)"},hiddenIfDark:{display:"var(--rui-app-hiddenIfDark)"}}),de=k.create`
    <div class="${ce.root}">
        <ul>
            <li class="${ce.hiddenIfDark}">
                ${()=>U.mount({variant:"plain",renderChildren:()=>`\n    <svg class="${ce.icon}" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">\n        <path d="M10 2a.75.75 0 0 1 .75.75v1.5a.75.75 0 0 1-1.5 0v-1.5A.75.75 0 0 1 10 2ZM10 15a.75.75 0 0 1 .75.75v1.5a.75.75 0 0 1-1.5 0v-1.5A.75.75 0 0 1 10 15ZM10 7a3 3 0 1 0 0 6 3 3 0 0 0 0-6ZM15.657 5.404a.75.75 0 1 0-1.06-1.06l-1.061 1.06a.75.75 0 0 0 1.06 1.06l1.06-1.06ZM6.464 14.596a.75.75 0 1 0-1.06-1.06l-1.06 1.06a.75.75 0 0 0 1.06 1.06l1.06-1.06ZM18 10a.75.75 0 0 1-.75.75h-1.5a.75.75 0 0 1 0-1.5h1.5A.75.75 0 0 1 18 10ZM5 10a.75.75 0 0 1-.75.75h-1.5a.75.75 0 0 1 0-1.5h1.5A.75.75 0 0 1 5 10ZM14.596 15.657a.75.75 0 0 0 1.06-1.06l-1.06-1.061a.75.75 0 1 0-1.06 1.06l1.06 1.06ZM5.404 6.464a.75.75 0 0 0 1.06-1.06l-1.06-1.06a.75.75 0 1 0-1.061 1.06l1.06 1.06Z"/>\n    </svg>\n`,onClick:()=>document.documentElement.setAttribute("data-color-scheme","dark")})}
            </li>
            <li class="${ce.hiddenIfLight}">
                ${()=>U.mount({variant:"plain",renderChildren:()=>`\n    <svg class="${ce.icon}" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">\n        <path fill-rule="evenodd" d="M7.455 2.004a.75.75 0 0 1 .26.77 7 7 0 0 0 9.958 7.967.75.75 0 0 1 1.067.853A8.5 8.5 0 1 1 6.647 1.921a.75.75 0 0 1 .808.083Z" clip-rule="evenodd"/>\n    </svg>\n`,onClick:()=>document.documentElement.setAttribute("data-color-scheme","light")})}
            </li>
        </ul>
    </div>
`,{classes:he}=F({root:{display:"flex",alignItems:"center",justifyContent:"space-between",height:"var(--rui-app-appBarHeight)",position:"fixed",top:0,left:0,right:0,backgroundColor:"var(--rui-palette-neutral-backgroundLevel2)",boxShadow:"var(--rui-shadow-sm)","& nav":{maxWidth:"100%",display:"flex",justifyContent:"flex-end",alignItems:"center","& ul":{display:"flex",justifyContent:"center",alignItems:"center",listStyle:"none",padding:0,"& li":{margin:"0 var(--rui-spacing-xs)"}}},"& nav$left":{flexGrow:1,justifyContent:"flex-start","& ul":{justifyContent:"flex-start"}},"& nav$lg":{display:"none"}},[I("sm")]:{"$root nav$lg":{display:"flex"},"$root li$sm":{display:"none"}},left:{},sm:{},lg:{},icon:{width:"24px",height:"24px",fill:"var(--rui-palette-neutral-main)","a:hover &":{fill:"var(--rui-palette-neutral-dark)"}},hiddenIfLight:{display:"var(--rui-app-hiddenIfLight)"},hiddenIfDark:{display:"var(--rui-app-hiddenIfDark)"},menuContent:{"& nav":{maxWidth:"100%",display:"flex",justifyContent:"flex-end",alignItems:"center","& ul":{display:"flex",justifyContent:"center",flexDirection:"column",alignItems:"center",listStyle:"none",padding:0,"& li":{margin:"var(--rui-spacing-md)"}}}}}),ge=k.create`
    <div class="${he.menuContent}">
        ${({options:e})=>["<nav><ul><li>",U.mount({href:"/api/",onClick:t=>{t.preventDefault(),e.handleNavigate("/api/"),e.handleOpen(!1)},label:"API",variant:"plain",size:"lg"}),"</li><li>",U.mount({href:"https://plnkr.co/edit/hLIWLlAHGsE2ojO1?preview",onClick:t=>{e.handleOpen(!1)},target:"_blank",label:"Playground",variant:"plain",size:"lg"}),"</li><li>",U.mount({href:"https://github.com/8tentaculos/cssfun",onClick:t=>{e.handleOpen(!1)},target:"_blank",label:"GitHub",variant:"plain",size:"lg",renderLeftIcon:()=>q(he.icon)}),"</li><li>",U.mount({href:"https://www.npmjs.com/package/cssfun",onClick:t=>{e.handleOpen(!1)},target:"_blank",label:"npm",variant:"plain",size:"lg",renderLeftIcon:()=>Y(he.icon)}),"</li></ul></nav>"]}
    </div>
`,ue=k.create`
    <div class="">
        ${({options:e})=>U.mount({renderChildren:()=>'\n    <svg class="undefined" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">\n        <path fill-rule="evenodd" d="M2 4.75A.75.75 0 0 1 2.75 4h14.5a.75.75 0 0 1 0 1.5H2.75A.75.75 0 0 1 2 4.75ZM2 10a.75.75 0 0 1 .75-.75h14.5a.75.75 0 0 1 0 1.5H2.75A.75.75 0 0 1 2 10Zm0 5.25a.75.75 0 0 1 .75-.75h14.5a.75.75 0 0 1 0 1.5H2.75a.75.75 0 0 1-.75-.75Z" clip-rule="evenodd"/>\n    </svg>\n',color:"primary",variant:"plain",size:"lg",onClick:()=>e.handleOpen(!0)})}
        ${({options:e})=>e.open?le.mount({handleClose:()=>e.handleOpen(!1),renderContent:e.renderContent,shadow:"lg"}):null}
    </div>
`,pe=k.create`
    <div class="${he.root}">
        <nav class="${he.left}">
            <ul>
                <li>
                    ${({options:e})=>U.mount({href:"/",onClick:t=>{t.preventDefault(),e.handleNavigate("/")},variant:"plain",renderChildren:()=>`\n                            <span>\n                                <img height="24" class="${he.hiddenIfLight}" alt="CSSFUN" src="/logo-dark.svg">\n                                <img height="24" class="${he.hiddenIfDark}" alt="CSSFUN" src="/logo.svg">\n                            </span>\n                        `})}
                </li>
            </ul>
        </nav>
        <nav class="${he.lg}">
            <ul>
                <li>
                    ${({options:e})=>U.mount({href:"/api/",onClick:t=>{t.preventDefault(),e.handleNavigate("/api/")},label:"API",variant:"plain"})}
                </li>
                <li>
                    ${()=>U.mount({href:"https://plnkr.co/edit/hLIWLlAHGsE2ojO1?preview",target:"_blank",label:"Playground",variant:"plain"})}
                </li>
                <li>
                    ${()=>U.mount({href:"https://github.com/8tentaculos/cssfun",target:"_blank",variant:"plain",renderChildren:()=>q(he.icon)})}
                </li>
                <li>
                    ${()=>U.mount({href:"https://www.npmjs.com/package/cssfun",target:"_blank",variant:"plain",renderChildren:()=>Y(he.icon)})}
                </li>
            </ul>
        </nav>
        <nav>
...
<li><strong><a target="_blank" href="https://github.com/8tentaculos/cssfun/tree/master/example/ssr">Rasti with Server-Side Rendering (SSR) Example</a></strong>: A Rasti application with server-side rendering using Express, highlighting how to use <strong>CSSFUN</strong> for styling in an SSR environment.</li>
        ...
        `,xe=e=>({fontFamily:`var(--rui-typography-${e}-fontFamily)`,fontWeight:`var(--rui-typography-${e}-fontWeight)`,fontSize:`var(--rui-typography-${e}-fontSize)`,lineHeight:`var(--rui-typography-${e}-lineHeight)`}),{classes:we}=F({root:{fontFamily:"var(--rui-fontFamily-body)",fontWeight:"var(--rui-fontWeight-xs)",fontSize:"var(--rui-fontSize-md)",lineHeight:"var(--rui-lineHeight-md)",padding:"var(--rui-spacing-lg)",margin:"0 auto",maxWidth:"var(--rui-app-maxWidth)",color:"var(--rui-palette-neutral-foregroundLevel2)","@global":{h1:{fontFamily:"var(--rui-fontFamily-body)",fontWeight:"var(--rui-fontWeight-xl)",fontSize:"var(--rui-fontSize-xxxl)",lineHeight:"var(--rui-lineHeight-xs)",color:"var(--rui-palette-neutral-foregroundLevel1)",margin:"var(--rui-spacing-lg) 0"},h2:{fontFamily:"var(--rui-fontFamily-body)",fontWeight:"var(--rui-fontWeight-xl)",fontSize:"var(--rui-fontSize-xxl)",lineHeight:"var(--rui-lineHeight-xs)",color:"var(--rui-palette-neutral-foregroundLevel1)",margin:"var(--rui-spacing-lg) 0",padding:"var(--rui-spacing-sm) 0",borderBottom:"1px solid rgba(var(--rui-palette-neutral-rgb-foregroundLevel1) / 0.2)"},h3:{fontFamily:"var(--rui-fontFamily-body)",fontWeight:"var(--rui-fontWeight-lg)",fontSize:"var(--rui-fontSize-xl)",lineHeight:"var(--rui-lineHeight-xs)",color:"var(--rui-palette-neutral-foregroundLevel2)",margin:"var(--rui-spacing-lg) 0",overflowY:"hidden",overflowX:"auto"},h4:{fontFamily:"var(--rui-fontFamily-body)",fontWeight:"var(--rui-fontWeight-lg)",fontSize:"var(--rui-fontSize-lg)",lineHeight:"var(--rui-lineHeight-md)",color:"var(--rui-palette-neutral-foregroundLevel3)",margin:"var(--rui-spacing-lg) 0"},h5:{fontFamily:"var(--rui-fontFamily-body)",fontWeight:"var(--rui-fontWeight-md)",fontSize:"var(--rui-fontSize-xl)",lineHeight:"var(--rui-lineHeight-md)",color:"var(--rui-palette-neutral-foregroundLevel3)",margin:"var(--rui-spacing-lg) 0"},p:{fontFamily:"var(--rui-fontFamily-body)",fontWeight:"var(--rui-fontWeight-xs)",fontSize:"var(--rui-fontSize-md)",lineHeight:"var(--rui-lineHeight-md)",color:"var(--rui-palette-neutral-foregroundLevel2)",margin:"var(--rui-spacing-lg) 0"},li:{fontFamily:"var(--rui-fontFamily-body)",fontWeight:"var(--rui-fontWeight-xs)",fontSize:"var(--rui-fontSize-md)",lineHeight:"var(--rui-lineHeight-md)",color:"var(--rui-palette-neutral-foregroundLevel2)",margin:"var(--rui-spacing-lg) 0"},"li::marker":{color:"var(--rui-palette-neutral-foregroundLevel3)"},"pre > code":{borderRadius:"var(--rui-borderRadius-sm)",boxShadow:"var(--rui-shadow-sm)",display:"block",background:"#282c34",color:"#abb2bf",overflowX:"auto",padding:"1em"},a:{color:"var(--rui-palette-primary-foregroundMain)",textDecoration:"none","&:visited, &:active":{color:"var(--rui-palette-primary-foregroundMain)"},"&:hover":{textDecoration:"underline",color:"var(--rui-palette-primary-foregroundDark)"}},table:{color:"var(--rui-palette-neutral-foregroundLevel1)",display:"block",overflowX:"auto",borderCollapse:"collapse","& th":{borderColor:"rgb(var(--rui-palette-neutral-rgb-foregroundLevel3) / 0.2)",borderStyle:"none",padding:"var(--rui-spacing-sm) var(--rui-spacing-md)",...xe("titleMd"),"& div":{display:"flex",alignItems:"center",justifyContent:"space-evenly"},"& svg:first-child":{padding:"0 var(--rui-spacing-xs) 0 0"},"& svg:last-child":{padding:"0 0 0 var(--rui-spacing-xs)"},"& svg:only-child":{padding:"0"}},"& td":{borderColor:"rgb(var(--rui-palette-neutral-rgb-foregroundLevel3) / 0.2)",borderStyle:"none",padding:"var(--rui-spacing-sm) var(--rui-spacing-md)",...xe("bodyMd")},"& thead th, & thead td":{borderBottomStyle:"solid",borderBottomWidth:"2px"},"& tfoot th, & tfoot td":{borderTopStyle:"solid",borderTopWidth:"2px"},"& tr:not(:last-child) td":{borderBottomStyle:"solid",borderBottomWidth:"1px"},"& td:not(:last-child), & th:not(:last-child)":{borderRightStyle:"solid",borderRightWidth:"1px"}}},marginTop:"var(--rui-app-appBarHeight)"}}),ke=k.create`
            <section class="${({options:e})=>(e=>[e.className||null,we.root].join(" "))(e)}"><h2 id="classes">Classes</h2>
<dl>
...
const Link = (\{ label, href \}) =&gt; &lt;a className=\{classes.link\} href=\{href\}&gt;\{label\}&lt;/a&gt;;
        ...
        `,{classes:Ee}=F({root:{display:"flex",justifyContent:"center",alignItems:"center",flexDirection:"column",padding:"var(--rui-spacing-xl) 0 var(--rui-spacing-xxxxl) 0",borderTop:"1px solid rgb(var(--rui-palette-neutral-rgb-foregroundLevel1) / 0.2)",backgroundColor:"var(--rui-palette-neutral-backgroundLevel2)","@global":{a:{color:"var(--rui-palette-neutral-main)",textDecoration:"none","&:visited, &:active":{color:"var(--rui-palette-neutral-main)"},"&:hover":{textDecoration:"underline",color:"var(--rui-palette-neutral-dark)"}}}},text:{color:"var(--rui-palette-neutral-foregroundLevel3)"}}),$e=k.create`
    <footer class="${Ee.root}">
        ${()=>X.mount({level:"titleMd",className:Ee.text,renderChildren:()=>'Released under the <a href="https://github.com/8tentaculos/cssfun/blob/master/LICENSE" target="_blank">MIT License</a>'})}
        ${()=>X.mount({level:"titleSm",className:Ee.text,renderChildren:()=>`Copyright © ${(()=>{const e=(new Date).getFullYear();return 2024===e?e:`2024-${e}`})()} <a href="https://github.com/8tentaculos" target="_blank">8tentaculos</a>`})}
    </footer>
`,{classes:Ce}=F({"@global":{body:{margin:0,backgroundColor:"var(--rui-palette-neutral-backgroundLevel1)"}},root:{}}),_e=(e="")=>{const t=e.match(/\/([^/]+)\//),r=t?t[1]:e;return["api"].includes(r)?r:""};k.create`
    <div class="${Ce.root}">
        ${e=>pe.mount({handleNavigate:e.navigate.bind(e)})}

        ${({state:e})=>"api"===e.route?ke.mount():[V.mount(),be.mount(),Se.mount()]}

        ${()=>$e.mount()}
    </div>
`.extend({preinitialize(e={}){this.state=new g({route:_e(e.route)}),"undefined"!=typeof window&&(window.history.replaceState({route:this.state.route},""),window.addEventListener("popstate",(e=>{e.state&&(this.state.route=_e(e.state.route))})))},navigate(e){this.state.route=_e(e),window.history.pushState({route:this.state.route},"",this.state.route?`/${this.state.route}/`:"/"),document.title=this.getTitle(),window.scrollTo(0,0)},getTitle(){return"CSSFUN"+("api"===this.state.route?" - API Documentation":"")}}).mount({route:window.location.pathname,onRender:t=>{e.highlightAll()}},document.getElementById("root"),!0)})()})();