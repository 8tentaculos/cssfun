...
For detailed API documentation, see: [API Documentation](https://cdn.jsdelivr.net/gh/8tentaculos/cssfun@v0.2.0-alpha.0/docs/api.md)
...
**Related API:**
- [`css(styles, [options])`](https://cdn.jsdelivr.net/gh/8tentaculos/cssfun@v0.2.0-alpha.0/docs/api.md#css) - Creates and attaches a StyleSheet
...
**Related API:**
- [`createTheme(themes, [options])`](https://cdn.jsdelivr.net/gh/8tentaculos/cssfun@v0.2.0-alpha.0/docs/api.md#createtheme) - Creates a theme StyleSheet
...
**Related API:**
- [`StyleSheet.toString()`](https://cdn.jsdelivr.net/gh/8tentaculos/cssfun@v0.2.0-alpha.0/docs/api.md#stylesheet_tostring) - Static method to render all instances as HTML
- [`StyleSheet.toCSS()`](https://cdn.jsdelivr.net/gh/8tentaculos/cssfun@v0.2.0-alpha.0/docs/api.md#stylesheet_tocss) - Static method to render all instances as CSS
...
**Related API:**
- [`StyleSheet`](https://cdn.jsdelivr.net/gh/8tentaculos/cssfun@v0.2.0-alpha.0/docs/api.md#stylesheet) - StyleSheet class documentation
...
- **Full API Documentation**: [api.md](https://cdn.jsdelivr.net/gh/8tentaculos/cssfun@v0.2.0-alpha.0/docs/api.md)
