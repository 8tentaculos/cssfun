 ...
 * `options.uidPrefix`, `options.generateClassName`, `options.generateId`, 
 * `options.attributes` and `options.renderers` will be added to the instance.
 * @param {String} options.prefix - The prefix for `uid` and data attribute.
 * @param {Function} options.generateUid - The function to generate the `StyleSheet` unique identifier.
 ...
 * @property {String} uid - The unique identifier for the stylesheet. It will be generated by `this.generateUid`.
